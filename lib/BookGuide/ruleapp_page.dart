...
class RuleappPage extends StatelessWidget {
  const RuleappPage({super.key});
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('กฏข้อบังคับของแอพพลิเคชัน'),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>
                          RuleappPage()), // Ensure correct class name
                );
              },
            ),
            ListTile(
